                        ...
                        <div class="card-body">
                            <form id="reg-form" action ="RegisterServlet" method="POST">
                                <div class="form-group">
                                    ...
                                    <input name ="user_name" type="text" class="form-control" id="user_name" aria-describedby="userHelp" placeholder="Enter Employee Name">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Email address</label>
                                    <input name ="email" type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Employee Email">
                                </div>
                                 <div class="form-group">
                                    <label for="mobile"> Mobile No.</label>
                                    <input name ="mobile" type="text" class="form-control" id="mobie_no" aria-describedby="userHelp" placeholder="Enter Employee mobile no ">
                                </div>
                                <div class="form-group">
                                    <label for="city"> Employee City</label>
                                    <input name ="city" type="text" class="form-control" aria-describedby="userHelp" placeholder="Enter Employee City">
                                </div>
                                <div class="form-group">
                                ...
                                <a href="index.jsp" class="btn btn-primary"> <span class=" fa fa-sign-in"></span> Alredy A User ! </a>
                            </form>
                        </div>
                    </div>
                </div>
